...
namespace Zivot\Mongodb\Passport\Bridge;

use Illuminate\Contracts\Events\Dispatcher;
use Zivot\Mongodb\Passport\Events\RefreshTokenCreated;
use Zivot\Mongodb\Passport\RefreshTokenRepository as PassportRefreshTokenRepository;
