...
namespace Zivot\Mongodb\Passport\Guards;
...
use Zivot\Mongodb\Passport\PassportUserProvider;
use Zivot\Mongodb\Passport\TokenRepository;
use Zivot\Mongodb\Passport\TransientToken;
...
class TokenGuard
{
     ...
     *
     * @var \Zivot\Mongodb\Passport\PassportUserProvider
     */
    protected $provider;
     ...
     * @param  \Zivot\Mongodb\Passport\PassportUserProvider  $provider
     * @param  \Zivot\Mongodb\Passport\TokenRepository  $tokens
